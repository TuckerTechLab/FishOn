...
const PreferredFishingLocation = ({navigation}) => {

    const [checkboxes, setCheckboxes] = useState([true, true,true,true,]);

    const [unCheckboxes, setUnCheckboxes] = useState([false, false,false,false,false,
    ...
    return (
        <View style={[styles.container, appStyle.appContainer]}>
            <View style={[styles.section1]}>
                ...
                <Text style={appStyle.titleSm}>Preferred Fishing Locations</Text>
            ...
            <View style={[styles.section3, appStyle.pt15, appStyle.btnGroup]}>
                <TouchableOpacity style={[appStyle.btnPrimary, appStyle.w100, appStyle.mr5]}
                                  onPress={() => navigation.navigate('PreferredFishingTechniques')}>
...
export default PreferredFishingLocation;
