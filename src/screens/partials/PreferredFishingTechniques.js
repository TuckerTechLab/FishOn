...
const PreferredFishingTechniques = ({navigation}) => {
    ...
    return (
        <View style={[styles.container, appStyle.appContainer]}>
            <View style={[styles.section1]}>
                ...
                <Text style={appStyle.titleSm}>Preferred Fishing Techniques</Text>
            ...
            <View style={[styles.section3, appStyle.pt15, appStyle.btnGroup]}>
                <TouchableOpacity style={[appStyle.btnPrimary, appStyle.w100, appStyle.mr5]}
                                  onPress={() => navigation.navigate('PreferredGearAndEquipment')}>
...
export default PreferredFishingTechniques;
